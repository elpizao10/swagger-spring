...
@Service
public class B_BBarnocchiService {
    @Autowired
    ...
    public void MetodoB_BBarnocchi() throws IOException{
        ...
        try {
            ...
            Long id = 11L;
            String denominazione = "Denominazione Esercente: BARNOCCHI Matilde “Al Castello” S.C.I.A. n.12160 del 04/05/2012";
            String indirizzo = "Indirizzo: Via V. Veneto, 11 2° p.";
            String contatti = "Contatti: 0804746454 - 3389149720";
            String email = "Email: alcastello2008@yahoo.it";
            String camere = "Camere: 3";
            String postiletto = "Posti letto: 7";
            String bagni = "Bagni: 3";
            String ristorazione = "Ristorazione: ";
            String periodo = "Periodo apertura: dal 24/02   al 02/11, dal 16/12   al 31/12";
