...
@Service
public class B_BAloisioService {
    @Autowired
    ...
    public void MetodoB_BAloisio() throws IOException{
        ...
        try {
            ...
            Long id = 14L;
            String denominazione = "Denominazione Esercente: ALOISIO Gina “Le case di sottovento” D.I.A. n.10735 del 30/06/2005";
            String indirizzo = "Indirizzo: Via G. Di Vagno, 63–69 1° p.";
            String contatti = "Contatti: 0804741886 - 3483392225";
            String email = "Email: info@lecasedisottovento.it";
            String camere = "Camere: 2";
            String postiletto = "Posti letto: 8";
            String bagni = "Bagni: 2";
            String ristorazione = "Ristorazione: ";
            String periodo = "Periodo apertura: dal 15/03   al 31/10, dal 01/12   al 31/12";
