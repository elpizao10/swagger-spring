...
@Service
public class CaseEappartamentiBellaPugliaService {
    @Autowired
    ...
    public void MetodoCaseAppartamentiBellaPuglia1() throws IOException {
        ...
        try {
            ...
            String indirizzo = "Indirizzo: C.da Lama Palomba, 5-7 1° piano";
