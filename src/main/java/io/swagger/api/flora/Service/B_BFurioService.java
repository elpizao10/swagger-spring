...
public class B_BFurioService {
    ...
    public void MetodoB_BFurio() throws IOException{
        ...
        try {
            ...
            Long id = 15L;
            String denominazione = "Denominazione Esercente: FURIO Rosanna “Souvenir d’eté” S.C.I.A. n. 19953 del 06/08/2018";
            String indirizzo = "Indirizzo: Via Valentino n. 9/11 Vico Solino n. 3 p.t.";
            String contatti = "Contatti: 3450684567";
            String email = "Email: furiorosanna@gmail.com";
            String camere = "Camere: 2";
            String postiletto = "Posti letto: 4";
            String bagni = "Bagni: 2";
            String ristorazione = "Ristorazione: ";
            String periodo = "Periodo apertura: dal 06/08 al 31/12";
