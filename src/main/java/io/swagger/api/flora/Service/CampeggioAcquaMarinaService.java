...
@Service
public class CampeggioAcquaMarinaService {
    @Autowired
    ...
    public void MetodoCampAcquaMarina() throws IOException{
        ...
        try {
            ...
            Long id = 1L;
            String denominazione = "Denominazione Esercente: Campeggio/ mini area  sosta “ACQUA MARINA” Rosalina s.r.l.";
            String indirizzo = "Indirizzo: SS 16 Km 819-219 complanare est per Bari, 19";
            String contatti = "Contatti: ";
            String camere = "Camere/Appartamenti: 30";
            String postiletto = "Posti letto: 150";
            String bagni = "Bagni: ";
