...
@Service
public class ForzaItaliaService {
    @Autowired
    ...
    public void MetodoForzaItalia() throws IOException{
        ...
        try {
            String partito = ((HtmlHeading3) page1.getFirstByXPath("//*[@id=\"_101_INSTANCE_ebXnc3wLmH19_121971\"]/div/div/div[1]/div/h3")).asNormalizedText();
            String nominativo = ((HtmlListItem) page1.getFirstByXPath("//*[@id=\"_101_INSTANCE_ebXnc3wLmH19_121971\"]/div/div/div[2]/div[2]/ul/li")).asNormalizedText();
