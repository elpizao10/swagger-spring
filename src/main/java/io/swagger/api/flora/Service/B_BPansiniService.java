...
@Service
public class B_BPansiniService {
    @Autowired
    ...
    public void MetodoB_BPansini() throws IOException{
        ...
        try {
            ...
            Long id = 2L;
            String denominazione = "Denominazione Esercente: PANSINI Onofrio “Casa Crispi” S.C.I.A. n. 26620 del 26/10/2018";
            String indirizzo = "Indirizzo: Via F. Crispi n. 23 Piano 1°";
            String contatti = "Contatti: 330911854 - 3485483145";
            String email = "Email: petdelre@gmail.com";
            String camere = "Camere: 1";
            String postiletto = "Posti letto: 3";
            String bagni = "Bagni: 1";
            String ristorazione = "Ristorazione: ";
            String periodo = "Periodo apertura: dal 29/10 al 31/12";
