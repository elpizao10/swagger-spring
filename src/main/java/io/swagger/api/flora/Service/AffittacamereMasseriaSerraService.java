...
@Service
public class AffittacamereMasseriaSerraService {
    @Autowired
    ...
    public void MetodoAffMasseriaSerra() throws IOException{
        ...
        try{
            ...
            Long id = 8L;
            String denominazione = "Denominazione Esercente: Affittacamere MASSERIA SERRA DELL’ISOLA       Guastamacchia Rita S.C.I.A. n. 9328 del 04/04/2014";
            ...
            String ristorazione = "Ristorazione: c/o agriturismo";
