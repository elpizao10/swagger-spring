...
@Service
public class Movimento5StelleService {
    @Autowired
    ...
    public void MetodoMov5Stelle() throws IOException{
        ...
        try {
            ...
            String partito = ((HtmlHeading3) page1.getFirstByXPath("//*[@id=\"_101_INSTANCE_ebXnc3wLmH19_122019\"]/div/div/div[1]/div/h3")).asNormalizedText();
            String nominativo = ((HtmlListItem) page1.getFirstByXPath("//*[@id=\"_101_INSTANCE_ebXnc3wLmH19_122019\"]/div/div/div[2]/div[2]/ul/li")).asNormalizedText();
