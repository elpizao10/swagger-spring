...
@Service
public class PopoloIdeaLibertaService {
    @Autowired
    ...
    public void MetodoPopoloIdea() throws IOException{
        ...
        try {
            String partito = ((HtmlHeading3) page1.getFirstByXPath("//*[@id=\"_101_INSTANCE_i6Dypv6w4L3K_121827\"]/div/div/div[1]/div/h3")).asNormalizedText();
            String nominativo1 = ((HtmlListItem) page1.getFirstByXPath("//*[@id=\"_101_INSTANCE_i6Dypv6w4L3K_121827\"]/div/div/div[2]/div[2]/ul/li[1]")).asNormalizedText();
            String nominativo2 = ((HtmlListItem) page1.getFirstByXPath("//*[@id=\"_101_INSTANCE_i6Dypv6w4L3K_121827\"]/div/div/div[2]/div[2]/ul/li[2]")).asNormalizedText();
            String nominativo3 = ((HtmlListItem) page1.getFirstByXPath("//*[@id=\"_101_INSTANCE_i6Dypv6w4L3K_121827\"]/div/div/div[2]/div[2]/ul/li[3]")).asNormalizedText();
